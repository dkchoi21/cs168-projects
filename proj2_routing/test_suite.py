...
def main():
    ...
    t.test('dv_router', 'tests.test_count_to_inf', extra_args=['--poison-mode'])
    t.test('dv_router', 'tests.test_fallback_direct')
    t.test('dv_router', 'tests.test_multiple_routers')

    t.test('dv_router', 'tests.test_topo_candy', extra_args=['--poison-mode'])

    t.test('learning_switch', 'tests.test_learning_link_down')

    t.test('dv_router', 'tests.test_dont_forget_direct_paths_after_failure2')

    
    t.test('dv_router', 'tests.test_simple_split_horizon')

    
    t.test('dv_router', 'tests.test_count_to_inf_v2', extra_args=['--poison-mode'])
