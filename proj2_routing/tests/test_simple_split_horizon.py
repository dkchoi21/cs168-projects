"""
Tests that the router performs simple split horizon.
...
to h2. The test passes if the ping does reach c1, meaning it was not dropped at
s1 because the route has not expired yet.
